...
return new class extends Migration
{
    ...
    {
        Schema::create('kompresszors', function (Blueprint $table) {
            $table->id("ID");
            ...
            $table->bigInteger('levegoSzenzor')->unsigned()->index();
            $table->foreign('levegoSzenzor')->references('ID')->on('sensors')->onDelete('cascade')->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('kompresszors');
    }
};
